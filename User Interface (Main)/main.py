...
input_txt = 'P(Class_i | Year_j).txt'  # 你的输入文件名
output_txt = 'P(Class_i | Date).txt'  # 输出文件名
...
# 写入到txt文件中
output_file_path = '../Gathered Data/Location_Ranking.txt'  # 调整为你的文件路径
...
ranking_file_path = '../Gathered Data/Location_Ranking.txt'
...
file_path = f"Generated Report/CS_Love_Report_for_{name}.txt"
